...
const LOREM_WORDS = [
  ...
  "odit", "fugit", "consequuntur", "magni", "dolores", "ratione", "sequi", "nesciunt"
];

const RANDOM_WORDS = [
  "adventure", "beautiful", "creative", "discovery", "elegant", "fantastic", "gorgeous", "harmony",
  "innovation", "journey", "kindness", "luminous", "magnificent", "nature", "opportunity", "peaceful",
  "quantum", "radiant", "sunshine", "tranquil", "universe", "vibrant", "wonderful", "xenial",
  "yearning", "zenith", "amazing", "brilliant", "charming", "delightful", "enchanting", "fabulous",
  "graceful", "heartwarming", "inspiring", "joyful", "kaleidoscope", "lovely", "marvelous", "nostalgic"
];
      ...
      case "sentences":
        ...
        for (let i = 0; i < count; i++) {
          ...
          for (let j = 0; j < sentenceLength; j++) {
            sentenceWords.push(wordList[Math.floor(Math.random() * wordList.length)]);
          }
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Generate Lorem Ipsum text or random words for placeholder content, mockups, and testing.
        </p>
      </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select value={textType} onValueChange={setTextType}>
                  ...
                  <SelectContent>
                    <SelectItem value="lorem">Lorem Ipsum (Classical)</SelectItem>
                    <SelectItem value="random">Random Words (Modern)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-2 text-sm text-muted-foreground">
                Characters: {output.length} | Words: {output.trim() ? output.trim().split(/\s+/).length : 0}
              </div>
            </CardContent>
          </Card>
        </div>
